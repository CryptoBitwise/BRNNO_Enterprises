...
export default function Testimonials() {
    const [ref] = useInView({ threshold: 0.3 }) as [React.RefObject<HTMLElement>, boolean];
    return (
                        ...
                        <SwiperSlide key={t.id}>
                            <div className="bg-white p-6 rounded-lg shadow-lg h-full flex flex-col">
                                ...
                                <p className="text-gray-600 text-sm">
                                    &quot;Reviva made booking my car detail so easy! The mobile service was convenient and the results were amazing.&quot;
                                </p>
                            </div>
                        </SwiperSlide>
                    ))}

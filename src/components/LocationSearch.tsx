...
import { FiMapPin, FiSearch, FiNavigation, FiStar, FiPhone, FiGlobe, FiClock } from "react-icons/fi";
...
export default function LocationSearch({ onServicesFound }: LocationSearchProps) {
                                        ...
                                        <div className="flex items-center space-x-4 mb-2">
                                            {service.phone && (
                                                <a
                                                    ...
                                                    className="flex items-center text-sm text-pink-600 dark:text-pink-400 hover:text-pink-700 dark:hover:text-pink-300"
                                                    title="Call"
                                                >
